...
contract Deploy is Script {
    function run() public {
        ...
        DrippableERC20Token _aToken = new DrippableERC20Token(
            "A token",
            "AAA",
            18
        );
        ...
        DrippableERC20Token _bToken = new DrippableERC20Token(
            "B token",
            "BBB",
            6
        );
        ...
        DrippableERC20Token _cToken = new DrippableERC20Token(
            "C token",
            "CCC",
            0
        );
